...
def set_schedule(pl_module):
    ...
    optimizer_grouped_parameters = [
        {
            "params": [
                ...
                and not any(dc in n for dc in feedback_names)
            ],
            "weight_decay": wd,
            "lr": lr,
        },
    ...
    if pl_module.hparams.config['feedback']:
        optimizer_grouped_parameters.append({
                "params": [
                    ...
                    and not any(bb in n for bb in head_names)
                    and not any(ht in n for ht in cross_modal_names)
                    and any(dc in n for dc in feedback_names)
                ],
                "weight_decay": wd,
                "lr": lr * lr_mult_feedback,
            })
